        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Desks_AspNetUsers_WorkerId",
                        column: x => x.WorkerId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DeskService", x => new { x.ServiceId, x.DeskId });
                    table.ForeignKey(
                        name: "FK_DeskService_Desks_DeskId",
                        column: x => x.DeskId,
                        principalTable: "Desks",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DeskService_Services_ServiceId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Desks_WorkerId",
                table: "Desks",
                column: "WorkerId");

            migrationBuilder.CreateIndex(
                name: "IX_DeskService_DeskId",
                table: "DeskService",
                column: "DeskId");
